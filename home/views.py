    ...
    if to_do['createPoliticianParties']:
        ...
        parties = {
            'bjp': {
                ...
                'party_logo': 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Bharatiya_Janata_Party_logo.svg/1200px-Bharatiya_Janata_Party_logo.svg.png',
                'candidate_name': '',
            ...
            'congress': {
                ...
                'party_logo': 'https://upload.wikimedia.org/wikipedia/commons/6/63/Indian_National_Congress_hand_logo.png',
                'candidate_name': '',
                'candidate_profile_pic': ''
                },
            'bsp': {
